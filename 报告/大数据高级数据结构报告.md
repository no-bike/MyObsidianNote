...
public class AverageRating {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("请输入要输出的前 k 个 asin 的数量：");
        int k = scanner.nextInt();
        scanner.close();

        String input = "hdfs://localhost:9000/ProductsRecommend/middleReduce/part-r-00000"; //文件输入路径
        String output = "hdfs://localhost:9000/ProductsRecommend/result";
        Configuration conf = new Configuration();
        conf.setInt("top.k", k);
